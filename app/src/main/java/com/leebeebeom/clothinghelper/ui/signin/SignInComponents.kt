...
@Composable
fun VisibleIcon(state: TextFieldUIState) {
    IconButton(onClick = state.visualTransformationToggle) {
        SimpleIcon(drawable = if (state.isVisible) R.drawable.ic_visibility_off else R.drawable.ic_visibility)
    }
}
